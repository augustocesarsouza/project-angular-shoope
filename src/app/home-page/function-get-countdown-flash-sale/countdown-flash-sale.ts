...
import { ObjTime } from "../header-body-home-shopee/home-body-main/home-body-main.component";

export const countdownFlashSale = (flashSaleCountdownService: FlashSaleCountdownService) : FlashSaleCountdown => {
  ...
  return functionGetTheValueTimeFleshOffer(objsHoursFleshOffersFilter[1].time, flashSaleCountdownService);
}

const functionGetTheValueTimeFleshOffer = (time: Date, flashSaleCountdownService: FlashSaleCountdownService): FlashSaleCountdown => {
  const flashSaleCountdown = flashSaleCountdownService.FlashSaleCountdownFunc(time);
